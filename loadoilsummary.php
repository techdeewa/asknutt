...
//http://www.settrade.com/C13_InvestorType.jsp
    ...
    function curl($url) {
        ...
        $scraped_page_raw = curl("https://www.bloomberg.com/energy");    // Downloading IMDB home page to variable $scraped_page
        $scraped_data = scrape_between($scraped_page_raw, "table-container__title", "table-container__title");   // Scraping downloaded dara in $scraped_page for content between <title> and </title> tags

        $wti = scrape_between($scraped_page_raw, "WTI Crude Oil (Nymex)", 'data-type="spark-line');
